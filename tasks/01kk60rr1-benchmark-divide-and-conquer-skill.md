...
Benchmark the divide-and-conquer skill by running it with and without the skill loaded, comparing quality, timing, token usage, and cost.
...
- [ ] Write improvement suggestions to `benchmark/suggestions/divide-and-conquer.md`
...
- `benchmark/suggestions/divide-and-conquer.md` written with improvement ideas
